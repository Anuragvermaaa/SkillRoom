...
const UserSignup = ({ closeModal, openLoginModal, showToast }) => {
...
//           errorMessage = "User signup endpoint not found. Please check server configuration.";
...
//         </button>
//         <button
//           onClick={() => navigate("/users/google-auth")}
