...
//       if (err.response) {
//         if (err.response.status === 404) {
//           errorMessage = "Business login endpoint not found.";
//         } else if (err.response.status === 401) {
//           errorMessage = "Invalid email or password";
//         } else if (err.response.data?.message) {
//           errorMessage = err.response.data.message;
...
//         </button>
//         <button onClick={() => navigate("/business/google-auth")} className="w-full p-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-md font-semibold hover:from-blue-600 hover:to-purple-600 transition-all duration-300 text-base flex items-center justify-center hover:scale-105">
...
//         </button>
//         <p className="text-center text-gray-400 text-sm">
//           New User? <button onClick={() => openSignupModal("business")} className="text-blue-400 hover:text-blue-300 transition-colors font-semibold">Sign Up</button>
//         </p>
//       </div>
//     </form>
//   );
