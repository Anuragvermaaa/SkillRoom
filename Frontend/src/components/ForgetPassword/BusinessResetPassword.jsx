...
const BusinessResetPassword = ({ closeModal, showToast }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsLoading(true);
    try {
      await resetPassword({ password, token, type: "business" });
      showToast("Password reset successfully!", "success");
      setErrors({});
      localStorage.removeItem("forgotEmail");
      localStorage.removeItem("forgotToken");
      console.log(`Navigating to /business/login after password reset`);
      setTimeout(() => {
